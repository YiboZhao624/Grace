...
train_prompt_micro_batch_size_per_gpu=2
...
MODEL_PATH=${MODEL_PATH:-"${RAY_DATA_HOME}/MODEL/PATH"}
CKPTS_DIR=${CKPTS_DIR:-"${RAY_DATA_HOME}/CKPT/PATH/${project_name}/${exp_name}"}
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/PROJ/PATH/data/SPECIFIC/DATAFILE"}
VAL_FILE=${VAL_FILE:-"${RAY_DATA_HOME}/PROJ/PATH/data/SPECIFIC/DATAFILE"}
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.ppo_micro_batch_size_per_gpu=${train_prompt_micro_batch_size_per_gpu} \
    ...
    custom_reward_function.path=/root/projects/RAGRL/src/custom_reward_v2.py \
